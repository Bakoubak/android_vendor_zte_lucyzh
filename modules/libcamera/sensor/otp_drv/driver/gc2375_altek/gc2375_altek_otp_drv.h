 ...
 **/
#define LOG_TAG "gc2375_altek_otp_drv"
#include <stdio.h>
#include <string.h>
#include <math.h>
#include <utils/Log.h>
...
#include "gc2375_altek_golden_otp.h"
...
#define MODULE_INFO_OFFSET 0x1000
#define MODULE_INFO_END_OFFSET 0x100F
#define MODULE_INFO_CHECKSUM 0x100F
/*AWB*/
#define AWB_INFO_GROUP_FLAG_OFFSET 0x0000 /*for Sensor OTP memory*/
#define AWB_INFO_OFFSET 0x1016
#define AWB_INFO_END_OFFSET 0x1022
#define AWB_INFO_CHECKSUM 0x1022
#define AWB_INFO_SIZE 6
#define AWB_SECTION_NUM 1
/*AF*/
#define AF_INFO_GROUP_FLAG_OFFSET 0x0000 /*for Sensor OTP memory*/
#define AF_INFO_OFFSET 0x1010
#define AF_INFO_END_OFFSET 0x1015
#define AF_INFO_CHECKSUM 0x1015
/*AE*/
#define AE_INFO_OFFSET 0x1E6C
#define AE_INFO_END_OFFSET 0x1E84
#define AE_INFO_CHECKSUM 0x1E84
/*Lens shading calibration*/
#define LSC_INFO_GROUP_FLAG_OFFSET 0x0000 /*for Sensor OTP memory*/
#define LSC_INFO_OFFSET 0x1033
#define LSC_INFO_END_OFFSET 0x146B
#define LSC_INFO_CHECKSUM 0x146B
#define LSC_INFO_CHANNEL_SIZE 270
#define LSC_DATA_SIZE 1096

/*optical center data*/
#define OPTICAL_INFO_OFFSET 0x1023

/*dualcamera data calibration*/
#define DUAL_INFO_OFFSET 0x046C
#define DUAL_INFO_END_OFFSET 0xE6B
#define DUAL_INFO_CHECKSUM 0xE6B
...
otp_drv_entry_t gc2375_altek_drv_entry = {
    .otp_cfg =
        {
            .cali_items =
                {
    ...
    .otp_ops =
        {
            .sensor_otp_create = gc2375_altek_otp_drv_create,
            .sensor_otp_delete = gc2375_altek_otp_drv_delete,
            .sensor_otp_read = gc2375_altek_otp_drv_read,
            .sensor_otp_write = gc2375_altek_otp_drv_write,
            .sensor_otp_parse = gc2375_altek_otp_drv_parse,
            .sensor_otp_calibration = gc2375_altek_otp_drv_calibration,
            .sensor_otp_ioctl = gc2375_altek_otp_drv_ioctl, /*expend*/
        },
    .otp_dep = {
        .is_depend_relation = TRUE, .depend_sensor_id = 0,
    }};
