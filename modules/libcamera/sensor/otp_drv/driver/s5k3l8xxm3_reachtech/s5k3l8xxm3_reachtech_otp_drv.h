 ...
 **/
#define LOG_TAG "s5k3l8xxm3_reachtech_otp_drv"
#include <stdio.h>
#include <string.h>
#include <math.h>
#include <utils/Log.h>
...
#include "s5k3l8xxm3_reachtech_golden_otp.h"
#include "cmr_sensor_info.h"

/*Module Vendor ID*/
#define MODULE_VENDOR_ID 0x03
...
#define DUAL_INFO_OFFSET 0x0
#define DUAL_INFO_END_OFFSET 0x0
#define DUAL_INFO_CHECKSUM 0x0
#define DUAL_DATA_SIZE 0x0
...
#define PDAF_SPC_SNC_INFO_OFFSET 0x0D0D
#define PDAF_SPC_SNC_INFO_END_OFFSET 0x0E0C
#define PDAF_SPC_SNC_INFO_CHECKSUM 0x0E0C
...
otp_drv_entry_t
    s5k3l8xxm3_reachtech_drv_entry =
        {
            .otp_cfg =
                {
                    .cali_items =
            ...
            .otp_ops =
                {
                    .sensor_otp_create = s5k3l8xxm3_reachtech_otp_drv_create,
                    .sensor_otp_delete = s5k3l8xxm3_reachtech_otp_drv_delete,
                    .sensor_otp_read = s5k3l8xxm3_reachtech_otp_drv_read,
                    .sensor_otp_write = s5k3l8xxm3_reachtech_otp_drv_write,
                    .sensor_otp_parse = s5k3l8xxm3_reachtech_otp_drv_parse,
                    .sensor_otp_calibration =
                        s5k3l8xxm3_reachtech_otp_drv_calibration,
                    .sensor_otp_ioctl =
                        s5k3l8xxm3_reachtech_otp_drv_ioctl, /*expend*/
                },
};
